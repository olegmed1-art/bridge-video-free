#!/usr/bin/env python3
"""Bridge Video 3.1 FREE r25.17: source-bound deal evidence and PBN.

This revision inherits r25.16 and adds a fail-closed, SHADOW_ONLY adapter for
card/auction evidence that is bound to the exact source video and verified
local frames.  It also publishes an evidence-preserving PBN when such a bundle
is present.  The revision does not install or approve a pixel recognizer and
does not promote observations to School Canon.
"""
