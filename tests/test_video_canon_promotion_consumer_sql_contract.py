...
def test_authority_and_independent_assurance_are_fail_closed():
    ...
    assert "'schema','video-canon-assurance-verdict-v2'" in MIGRATION
    assert "'verification_bundle_sha256',v.verification_bundle_sha256" in MIGRATION
...
def test_delivery_is_leased_fenced_atomic_and_retained():
    ...
    assert "VIDEO_CANON_ENQUEUE_EFFECTIVE_PERIOD_EXPIRED" in MIGRATION
