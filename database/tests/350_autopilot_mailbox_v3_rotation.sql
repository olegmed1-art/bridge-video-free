...
BEGIN
 ...
 IF NOT EXISTS(SELECT 1 FROM autopilot.role_dispatch_mailbox_registry WHERE mailbox_pr=1685 AND lifecycle='ACTIVE' AND max_dispatches=40) THEN RAISE EXCEPTION 'AUTOPILOT_0350_1685_NOT_ACTIVE'; END IF;
