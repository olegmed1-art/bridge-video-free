...
COMMENT ON COLUMN deal.stable_key IS
    'Stable school-scoped deal identity; reconciled into migration history by 0038.';
COMMENT ON COLUMN skill.stable_key IS
    'Stable school-scoped skill identity; reconciled into migration history by 0038.';

INSERT INTO schema_migration(migration_key)
VALUES ('0038_deal_skill_stable_key_reconciliation')
