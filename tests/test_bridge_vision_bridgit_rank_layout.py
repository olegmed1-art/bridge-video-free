...
def test_peak_chain_rejects_competing_edge_anchors():
    values = [0.0] * 200
    for index, score in (
        (95, 0.95),
        (120, 0.91),
...
def test_peak_chain_edge_fallback_cannot_bridge_competing_starts():
    values = [0.0] * 200
    for index, score in (
        (95, 0.80),
        (120, 0.91),
        ...
        values[index] = score
    for index, score in enumerate((0.81, 0.82, 0.83, 0.84, 0.85), start=100):
        values[index] = score
