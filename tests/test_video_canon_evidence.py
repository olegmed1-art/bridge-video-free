...
@pytest.mark.parametrize("statement", [
    ...
    "partner has the nine of spades",
    "opponent holds two of clubs",
    "North has the heart seven",
    "partner has the nine",
    "opponent holds the two",
    "North has the seven",
    "North has ♠Q",
    "North has ♥Q",
    "North has ♦10",
    ...
    "У противника QH",
    "противник держит AS",
    "противник имеет туз пик",
    "у партнера девятка пик",
    "партнер держит двойку треф",
    "у противника семёрка червей",
    "у партнера нет пик",
    "партнер без пик",
    "у противника нет червей",
    "соперник не имеет бубен",
    "у партнера нет туза",
    "партнер без короля",
    "соперник не держит девятку",
    "у противника нет 2C",
    ...
    "L.H.O has the ace of spades",
    "R.H.O. has the queen of hearts",
    "Партнёр: туз пик",
    "Соперник: Q",
])
...
@pytest.mark.parametrize("statement", [
    ...
    "South hand: 7 losers",
    "North held 5 hearts",
    "partner has five cards",
    "North held five hearts",
    "North has five to seven cards",
    "partner has the two-level response",
    "partner has the two-over-one bid",
    "North has the seven-card suit",
    "partner has a forcing bid",
    "North has a response",
