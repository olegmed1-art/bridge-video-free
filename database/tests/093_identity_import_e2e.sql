...
BEGIN
    ...
    VALUES (v_school,'manual_import','Synthetic identity E2E regression')
    ...
    VALUES ('Synthetic Existing Identity E2E')
    ...
    VALUES (v_source,'e2e-existing-001','Synthetic Existing Identity E2E')
    ...
    INSERT INTO identity_staging.identity_import_batch(
        ...
        v_school,v_source,'e2e-ready-batch','Synthetic ready E2E',
        jsonb_build_object('test','identity-import-e2e')
    ...
    INSERT INTO identity_staging.identity_import_item(
        ...
        jsonb_build_object('name','Synthetic Existing Identity E2E','email','synthetic-existing@example.invalid'),
        v_source_identity,jsonb_build_object('preferred_name','Synthetic Existing Identity E2E')
    ...
    INSERT INTO identity_staging.identity_import_item(
        ...
        v_batch,'new-record',
        jsonb_build_object('name','Synthetic New Identity E2E','email','synthetic-new@example.invalid'),
        jsonb_build_object('preferred_name','Synthetic New Identity E2E')
    ...
    ) VALUES (v_new_item,'create_new_person','explicit create intent only');
    INSERT INTO identity_staging.identity_import_item_state_event(
        identity_import_item_id,state,reason
    ...
    ) VALUES (v_school,v_source,'e2e-unresolved-batch','Synthetic unresolved E2E')
