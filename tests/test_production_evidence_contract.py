#!/usr/bin/env python3
"""Permanent production guard for the evidence-preserving 3.1 FREE r25.17 route.

r25.17 remains a thin descendant of r25.16 and adds only source-bound SHADOW
deal evidence intake plus evidence-preserving PBN. Identity, privacy,
methodology and zero-paid-AI guards remain intact.
"""
...
import bridge_runtime_hardening_r25_17 as runtime
from bridge_output_scoped_idempotency import existing_same_revision_done
import check_completed_job as preflight
import run_master_3_1_free as base


def test_production_route_is_confirmed_r25_17_with_inheritance_chain():
    ...
    runtime_source = Path("bridge_runtime_hardening_r25_17.py").read_text(encoding="utf-8")
    ...
    assert "bridge_runtime_hardening_r25_17" in adapter
    assert 'BRIDGE_REQUESTED_ALGORITHM_REVISION: "3.1-free-r25.17"' in workflow
...
if __name__ == "__main__":
    test_production_route_is_confirmed_r25_17_with_inheritance_chain()
    ...
    print("PRODUCTION_R25_17_EVIDENCE_CONTRACT: PASS")
