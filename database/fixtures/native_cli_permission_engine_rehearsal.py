...
from database.fixtures.native_cli_postcommit_runtime_rehearsal import run as run_postcommit_runtime
    ...
    try:
        with tempfile.TemporaryDirectory(prefix='native-permissions-') as directory:
            ...
            with connection() as conn:
                ...
                run_postcommit_runtime(TARGET, path, manifest_digest, CIGuard)
