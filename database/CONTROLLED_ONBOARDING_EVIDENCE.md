...
Final Evidence Gate for migrations `0102_identity_controlled_onboarding`, `0103_auth_portal_actor_context_signature_fix`, and `0104_auth_actor_context_clock_consistency` on the corrected current main tree.
...
- same-transaction portal revoke/restore uses one wall-clock validity instant so a freshly restored authorization is immediately usable.
