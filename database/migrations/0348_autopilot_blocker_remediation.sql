...
SELECT CASE
 ...
 WHEN p_result_code IN ('QA_GATES_FAILED','FINDINGS_REQUIRE_REPAIR','VIRTUALENV_INTERPRETER_REQUIRED','HISTORICAL_RULE_CONTENT_MUTABLE','FINDING_STALE_BLOCK_LEDGER') THEN 'REPOSITORY_REPAIR'
