...
COMMENT ON COLUMN deal.stable_key IS
    'Stable school-scoped deal identity; reconciled into migration history by 0050.';
COMMENT ON COLUMN skill.stable_key IS
    'Stable school-scoped skill identity; reconciled into migration history by 0050.';

INSERT INTO schema_migration(migration_key)
VALUES ('0050_deal_skill_stable_key_reconciliation')
