...
DO $$
DECLARE wid uuid; tid uuid; action text; token text:=repeat('a',64);
BEGIN
 ...
 VALUES('test-0351-close','AUTOPILOT',1150,0,'PAUSED','sql-test','SQL_TEST','REPOSITORY_AUDIT','0351 close test','TARGET_SUPERSEDED_BY_CURRENT_MAIN',1685)
