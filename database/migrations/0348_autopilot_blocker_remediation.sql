...
SELECT CASE
 ...
 WHEN p_result_code IN ('QA_GATES_FAILED','FINDINGS_REQUIRE_REPAIR','VIRTUALENV_INTERPRETER_REQUIRED','HISTORICAL_RULE_CONTENT_MUTABLE','FINDING_STALE_BLOCK_LEDGER','RECOGNIZER_READINESS_GAP','TECHNICAL_TEST_FAILURE') THEN 'REPOSITORY_REPAIR'
