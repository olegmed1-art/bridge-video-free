...
def run():
 ...
 assert not claim_allowed(board_status='PLAYED',claim_type='SPECIFIC_BIDDING_ERROR',trade_evidence=False)
 assert claim_allowed(board_status='PLAYED',claim_type='SPECIFIC_BIDDING_ERROR',trade_evidence=True)
