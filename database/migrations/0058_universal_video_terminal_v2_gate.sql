...
-- Forward-only terminal-v2 gate. The SQL payload is kept as composite parts so
...
\ir 0058_universal_video_terminal_v2_gate/002_require_terminal_revisions.sql
