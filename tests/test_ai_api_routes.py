...
def test_ai_routes_are_registered():
    routers = [ai_router, ai_teacher_router, ai_policy_router, ai_orchestrator_router, ai_worker_router, ai_decision_router]
    ...
    assert "/v1/ai/positions/{position_id}/teacher-evidence" in paths
    assert "/v1/ai/positions/{position_id}/policy-evidence" in paths
    assert "/v1/ai/positions/{position_id}/process" in paths
