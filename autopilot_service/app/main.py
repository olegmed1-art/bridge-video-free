...
from app.workflows.shadow_wait import ShadowSignal
...
async def resume_shadow_wait(
    ...
    Phase 1 deliberately has no public workflow-start endpoint.  The exact Python
    startup API must first be discovered and pinned by the compatibility job.
    """
